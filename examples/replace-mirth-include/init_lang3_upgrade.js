...
new MirthEnvBuilder(this).setMirthPath('/home/tony/mirth/release/3.7.1')
    ...
    // .applyToClassLoaderBuilder(builder => builder.addUrlString('https://repo1.maven.org/maven2/org/apache/commons/commons-lang3/3.9/commons-lang3-3.9.jar'))

    // Better to load locally.
    // .applyToClassLoaderBuilder(builder => builder.addUrlString('file:///home/tony/mirth/resources/commons-lang3-3.9.jar'))
    ...
    */
    .applyToClassLoaderBuilder(function(builder) {
        builder.addUrlString('file:///home/tony/mirth/resources/commons-lang3-3.9.jar')
